module.exports = {
	...
	disconnectTime: 600000, //- How long should the bot wait before disconnecting from the voice channel (in miliseconds). Set to 1 for instant disconnect.
	...
	cookieSecret: "my cookie <3", //- Cookie Secret
	...
	nodes: [
		{
			...
			port: Number(process.env.lavalinkPort) || 2000, // The port that lavalink is listening to. This must be a number!
			password: process.env.lavalinkPassword || "www.freelavalink.ga", //- The password of the lavalink server.
			...
			secure: process.env.lavalinkSecure ? process.env.lavalinkSecure.toLowerCase() == 'true' : false, //- Can be either true or false. Only use true if ssl is enabled!
		},
	],
